...
int main(int argc, char **argv)
{
  ...
  printf("=========================\n");
  printf("CHATTING PROGRAM - CLIENT\n");
  printf("=========================\n");
  ...
  pthread_create(&snd_thread, NULL, send_message, (void*)(intptr_t) sock);
  pthread_create(&rcv_thread, NULL, recv_message, (void*)(intptr_t) sock);
